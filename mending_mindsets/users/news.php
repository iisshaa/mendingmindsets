...
$query = "CREATE TABLE news (Srno int NOT NULL PRIMARY KEY , Email Varchar(50))";
 ...
 if($email == '')
    {
        ...
        exit;
            ...
            $query="INSERT INTO news VALUES(NULL,'$email')";
            $exec_query=mysqli_query($conn,$query);
            if($exec_query==true)
            {
              echo '<script type="text/javascript">

              window.onload = function () { alert("Thankyou For Subscribing To Our Newsletter!!"); }
